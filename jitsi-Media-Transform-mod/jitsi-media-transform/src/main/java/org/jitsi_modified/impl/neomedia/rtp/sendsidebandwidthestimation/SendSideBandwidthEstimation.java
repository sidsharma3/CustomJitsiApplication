...
public class SendSideBandwidthEstimation
{
    ...
    private synchronized long capBitrateToThresholds(long bitrate)
    {
        ...
        //changed
        logger.info("from JMT forced bitrate to be 2.5mbps");
        bitrate = 2500000;
        return bitrate;
    }
    ...
    synchronized public void setMinMaxBitrate(int min_bitrate, int max_bitrate)
    {
        ...
        // changed
        max_bitrate_configured_ = 2500000;
        min_bitrate_configured_ = 2500000;
    }
    ...
    private synchronized void setBitrate(long newValue)
    {
        //changed
        newValue = 2500000;
        logger.info("333 from JMT forcing br to be 2.5mbps");
        bitrate_ = newValue;
    }
